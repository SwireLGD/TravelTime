                ...
                <div className="container">
                    ...
                    <div className="routeCards">
                        <div className="routeCard">
                            ...
                            <p className="routeCardText">Именно здесь самый красивый прозрачный лёд. <br />Каждый день вы будете видеть новые места, которые вы будете долго помнить</p>
                        </div>
                        <div className="routeCard">
                            <h5 className="routeCardHeader">Покатаетнесь на коньках по Байкалу</h5>
                            <p className="routeCardText">Зимой Байкал - самый большой каток в мире. Предлагаем вам кататься на коньках на стоянках и в свободное время, это незабываемое ощущение!</p>
                        </div>
                        <div className="routeCard">
